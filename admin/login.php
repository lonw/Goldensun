...
<html>
	<head>
		<title>Admin Login - Goldensun Management System</title>
		<!-- Bootstrap -->
	...
	<body id="login">
		<div class="container">
		  ...
		  <form name="login" action="functions/autentifikasi.php" method="post" class="form-signin">
			<h2 class="form-signin-heading" align="center">Goldensun System</h2>
